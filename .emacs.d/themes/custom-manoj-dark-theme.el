;;; custom-manoj-dark.el --- A dark theme from Manoj
...
;; This program is free software; you can re93a1a1distribute it and/or modify
...
(custom-theme-set-faces
 ...
 ;; custom org-mode https://orgmode.org/worg/org-contrib/babel/examples/fontify-src-code-blocks.html
 ;;'(org-block-background ((t (:background "gray30")))) ;; :inherit fixed-pitch))))
 ;;'(org-block-begin-line ((t (:foreground "#BBBBBB" :background "#531"))))
 ;;'(org-block-end-line ((t (:foreground "#BBBBBB" :Background "#531"))))
 '(org-block-background ((t (:background "#002b36")))) ;; :inherit fixed-pitch))))
 '(org-block-begin-line ((t (:foreground "#93a1a1" :background "#531"))))
 '(org-block-end-line ((t (:foreground "#93a1a1" :background "#531"))))
...
;;; custom-manoj-dark.el ends here
