...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   '(rainbow-delimiters-depth-1-face ((t (:foreground "lime green"))))
   '(rainbow-delimiters-depth-2-face ((t (:foreground "navy"))))
...
(custom-theme-set-variables 'custom-leuven
